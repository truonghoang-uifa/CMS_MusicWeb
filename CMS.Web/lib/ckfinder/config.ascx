...
<script runat="server">
    ...
    public override bool CheckAuthentication()
    {
        ...
        {
            HVIT.Security.TokenProvider tokenProvider = new HVIT.Security.TokenProvider();
            HVIT.Security.TokenIdentity tokenIdentity = new HVIT.Security.TokenIdentity();
            tokenIdentity.UserAgent = this.Request.UserAgent.ToString();

            if (this.Request.UserHostAddress != null)
                tokenIdentity.IP = this.Request.UserHostAddress;
    ...
    public override void SetConfig()
    {
        ...
        BaseUrl = "http://" + HttpContext.Current.Request.Url.Authority + "/FilesUpload/";
        //BaseUrl = "~/FilesUpload/";

        // The phisical directory in the server where the file will end up. If
        // blank, CKFinder attempts to resolve BaseUrl.
        BaseDir = Server.MapPath("/FilesUpload/");
